...
def get_Cambio_Dolar(d):
    table = d.find_all('div', class_='periods')
    Titulo = d.find_all('span', class_='small-hide')
    Cambio = d.find_all('a', class_='change down')
...
def main():
    ...
    print()
    print("El cambio del dolar es de " + get_Cambio_Dolar(soup))
